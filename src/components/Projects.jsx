...
function Projects() {
  return (
    <div className='self-center w-[90%] rounded mt-4 flex flex-col justify-center items-center gap-2 p-1 bg-opacity-100'>
        ...
        <div className='bg-neutral-900 p-1 w-max rounded-md hover:bg-[#E5E5E5] hover:text-black hover:border-2 hover:border-black'><Link to='/projects/digitalclock'>Digital Clock</Link> </div>
        <div className='bg-neutral-900 p-1 w-max rounded-md hover:bg-[#E5E5E5] hover:text-black hover:border-2 hover:border-black'><Link to='/'>MyPortfolio </Link> </div>
        <div className='bg-neutral-900 p-1 w-max rounded-md hover:bg-[#E5E5E5] hover:text-black hover:border-2 hover:border-black'><Link to=''>More to Add ...</Link> </div>
