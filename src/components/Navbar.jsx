...
function Navbar() {
  return (
    <div className='flex justify-between p-2 bg-black items-center w-screen'>
        ...
        <div className='flex justify-between bg-yellow-0 w-[80%] p-0 items-center justify-between text-xs md:text-2xl px-4'>
